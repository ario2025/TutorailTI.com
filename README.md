This is a simple github project to redirect users from a website where a URL was changed to another one, but with the same pathname on forward, without using server-side, it's only uses javascript.
